...
class TeamsStatsOverviewTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let detailVC = segue.destination as! TeamsStatsTableViewController
        let selectedIndexPath = tableView.indexPathForSelectedRow
        detailVC.teamId = teamsData[(selectedIndexPath?.row)!].id!
